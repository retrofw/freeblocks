...
bool sysInit() 
{
    ...
    // real_screen = SDL_SetVideoMode(320,240,16,SDL_FLAGS);
	// screen = SDL_CreateRGBSurface(SDL_HWSURFACE, SCREEN_WIDTH, SCREEN_HEIGHT, 16, 0,0,0,0);
...
void sysConfigApply() {
    ...
    // real_screen = SDL_SetVideoMode(320,480,16,SDL_FLAGS);
	SDL_ShowCursor(SDL_DISABLE);
